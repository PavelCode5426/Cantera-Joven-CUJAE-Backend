...
from custom.authentication.serializer import CustomAuthTokenSerializer, \
    DirectoryUserAPIKeySerializer, DirectoryUserWithRolesSerializer
...
class CustomObtainAuthToken(ObtainAuthToken):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid(True):
            ...
            user = DirectoryUserWithRolesSerializer(user).data
